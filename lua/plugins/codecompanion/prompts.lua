...
local function load_system_prompt(prompt_name)
	...
	local prompt_path = config_dir .. "/lua/plugins/codecompanion/utils/prompts/" .. prompt_name .. ".txt"
				...
				prompts = {
					{
						...
						content = function()
							...
							local logs =
								vim.fn.system('git log --pretty=format:"%s%n%b" -n 50')
							local commit_history = "Commit history for branch "
								.. current_branch
								.. ":\n"
								.. logs
								.. "\n\n"
				...
				prompts = {
					{
						...
						content = function()
							local notes =
								require("util.glab.notes").get_unresolved_discussions()
