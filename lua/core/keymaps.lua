local map = vim.keymap.set -- for connciseness
...
map("n", "<leader>fmd", vim.lsp.buf.format, { desc = "Format document with LSP" })
...
local diagnostic_goto = function(next, severity)
	...
	return function()
		vim.diagnostic.jump({ count = go, float = true, severity = severity })
	end
end
